...
Advanced Metadata Cache extends `app.metadataCache.getBacklinksForFile` with three ways to call it. The fast and safe versions accept a `TFile` **or** a vault path string; the original accepts a `TFile`.
