...
/**
 * Longer than the 30s default, and specific to this plugin: the shots are taken
 * in a vault of thousands of notes, which Obsidian has to index before a single
 * frame means anything.
 */
const CAPTURE_TEST_TIMEOUT_IN_MILLISECONDS = 600_000;
    ...
    return [
      {
        test: {
          ...context.desktop,
          hookTimeout: CAPTURE_TEST_TIMEOUT_IN_MILLISECONDS,
