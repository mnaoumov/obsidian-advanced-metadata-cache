...
import { CAPTURE_HOOK_TIMEOUT_IN_MILLISECONDS } from './helpers/capture-budget.ts';
    ...
    return [
      {
        test: {
          ...context.desktop,
          hookTimeout: CAPTURE_HOOK_TIMEOUT_IN_MILLISECONDS,
          include: [DESKTOP_CAPTURE_TEST_FILES],
          name: 'capture-screenshots:desktop',
          testTimeout: CAPTURE_HOOK_TIMEOUT_IN_MILLISECONDS
        }
      },
      {
        test: {
